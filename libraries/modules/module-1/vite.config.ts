...
let defineEnv: any;
const isRemote = process.env.VITE_MODULE1_IS_REMOTE?.trim() === 'true';

if (isRemote) {
  defineEnv = {
    'process.env.NODE_ENV': JSON.stringify(process.env.NODE_ENV || 'production'),
    'process.env.VITE_MODULE1_IS_REMOTE': JSON.stringify(process.env.VITE_MODULE1_IS_REMOTE),
  };
}
