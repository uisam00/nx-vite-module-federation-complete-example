...
export const ModuleFederationConfig: ModuleFederationOptions = {
  ...
  exposes: {
    ...
    // under the public name './Module2Remote'.
    // to be able to import this component we must declare an alias in tsconfig.base.json like: 'Module2/Module2Remote'
