...
export const ModuleFederationConfig: ModuleFederationOptions = {
  ...
  exposes: {
    ...
    // under the public name './Section2Remote'.
    // to be able to import this component we must declare an alias in tsconfig.base.json like: 'Section2/Section2Remote'
    './Section2Remote': './src/index.ts',
  },
