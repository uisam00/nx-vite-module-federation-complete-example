...
export const ModuleFederationConfig: ModuleFederationOptions = {
  ...
  exposes: {
    ...
    // under the public name './Section1Remote'.
    // to be able to import this component we must declare an alias in tsconfig.base.json like: 'Section1/Section1Remote'
    './Section1Remote': './src/index.ts',
  },
